...
class Center_Three(SerialInstrument):
    def __init__(self, name="", address='COM7', enabled=True, timeout=.5, config_path=None, baudrate=38400):
        self.query_sleep = .05
        self.timeout = timeout
        self.rec_length = 1024
        self.s_handle = SerialInstrument.__init__(self, name, address, enabled, timeout, baudrate=baudrate,
